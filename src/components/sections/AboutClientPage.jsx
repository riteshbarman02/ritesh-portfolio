      ...
      <div className="w-full max-w-6xl mx-auto px-6 pt-32 flex flex-col gap-8 pb-20">
        ...
        <div className="text-center md:text-left flex flex-col gap-3">
          ...
          <p className="text-xl font-body text-text-subheading font-bold">
            ~ The person behind the drawings and code ~
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            ...
            <div className="bg-background doodle-border doodle-shadow p-3 max-w-[280px] mx-auto lg:mx-0 -rotate-2 hover:rotate-0 hover:scale-105 transition-all duration-200">
              <img 
                src="/svg/profile_doodle.png" 
                alt="Ritesh Barman Doodle Portrait" 
                className="w-full h-auto object-cover bg-primary/5"
              />
              <p className="text-center font-cursive text-lg font-bold text-text-subheading mt-2">Self Portrait ✏️</p>
            </div>
            ...
            <div className="bg-background doodle-border-sm doodle-shadow p-6 bg-opacity-40 relative">
              ...
              <div className="pl-6 flex flex-col gap-4">
                ...
                <ul className="flex flex-col gap-3 font-body text-base">
                  ...
                  <li>
                    <span className="font-bold text-primary font-cursive text-lg">Focus:</span> Frontend UI / Interactive Web applications
                  </li>
                  <li>
                    <span className="font-bold text-primary font-cursive text-lg">Location:</span> Pune, India 🇮🇳
                  </li>
                  <li>
            ...
            <div className="bg-background doodle-notebook-page p-8 bg-opacity-40 relative">
              ...
              <div className="pl-8 flex flex-col gap-6">
                ...
                <div className="font-body text-lg text-text flex flex-col gap-4 leading-relaxed">
                  ...
                  <p>
                    As a <span className="doodle-highlight font-bold">Dakshana Scholar</span>, I was selected through an intense national scholarship program designed to nurture academic potential. This background taught me discipline, problem-solving from first principles, and continuous technical refinement.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="pl-8 flex flex-col gap-6">
                ...
                <div className="flex gap-4 items-start relative pl-4 border-l-2 border-dashed border-border/20 py-2">
                  ...
                  <div className="flex flex-col gap-2 font-body text-text">
                    ...
                    <span className="text-sm font-bold text-text-subheading">Avkalan Labs • Jan 2024 - Present</span>
                ...
                <div className="flex gap-4 items-start relative pl-4 border-l-2 border-dashed border-border/20 py-2">
                  ...
                  <div className="flex flex-col gap-2 font-body text-text">
                    ...
                    <span className="text-sm font-bold text-text-subheading">Avkalan Labs • Mid 2023 - Dec 2023</span>
                    <p className="text-base leading-relaxed mt-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                  ...
                  <div className="border-2 border-border doodle-border-sm p-4 bg-background bg-opacity-20 flex flex-col gap-3 hover:-rotate-1 transition-transform duration-200">
                    ...
                    <div className="font-body text-base text-text flex flex-col gap-2">
                      ...
                      <span className="text-sm text-text-subheading font-bold">Avasari, Pune</span>
                      <span className="text-sm text-text-subheading">Bachelor of Engineering (B.E.)</span>
                      <div className="mt-2 py-1 px-3 border border-dashed border-primary/20 bg-primary/5 rounded w-fit">
                        <span className="font-cursive text-lg font-bold text-primary">Cumulative CGPA: 7.94</span>
                      </div>
                    </div>
                  </div>
