        ...
        {blogs.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {blogs.map((post) => (
              <article 
                key={post.slug} 
                className="bg-background doodle-notebook-page p-6 flex flex-col justify-between hover:-rotate-1 hover:scale-[1.01] transition-all duration-200"
              >
                ...
                <div className="pl-6 flex flex-col gap-4">
                  ...
                  {/* Title */}
                  <h2 className="text-3xl font-bold font-cursive text-text-heading hover:text-primary transition duration-150">
